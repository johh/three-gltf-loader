...
![three.js version](https://img.shields.io/badge/three.js-v0.97.0-green.svg?style=flat-square)
...
## Description
three.js's r97 [GLTFLoader](https://threejs.org/docs/#examples/loaders/GLTFLoader) wrapped as a module for easy importing.
